function [Qfol, Rfol, GT_file] = Load_Paths_TrainSet(Dataset, HPC, Win)
...
%         Qfol = '/home/n7542704/Datasets/Berlin_Kudamm/Query_Train';
%         Rfol = '/home/n7542704/Datasets/Berlin_Kudamm/Reference_Train';
%         %need to re-create the gps matrix
%         GT_file = load('/home/n7542704/Datasets/Berlin_Kudamm/Berlin_GPSMatrix_50meters_Train.mat');
