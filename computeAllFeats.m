...
saveFolder = 'Features_Nordland_Cont/';
...
save('Load_Times_Nordland_TestSet.mat','Time_CNNWhole','Time_HOG','Time_KAZE',...
    'Time_NetVLAD','Time_OLO','Time_SAD','Time_SURF','Time_Gist','Time_CNNHeat');
